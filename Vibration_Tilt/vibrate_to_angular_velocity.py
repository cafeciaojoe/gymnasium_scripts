...
min_power = 40000   # Minimum motor power 
max_power = 5000  # Maximum motor power 

# Angular velocity response settings
max_angular_velocity_dps = 200  # Maximum expected angular velocity (degrees per second)
...
vibration_exponent = 1.8  # Controls vibration intensity curve
...
def start_position_printing(scf):
    ...
    """
    log_conf = LogConfig(name='Quaternion_Attitude', period_in_ms=50)  # 20 Hz for better velocity estimation
